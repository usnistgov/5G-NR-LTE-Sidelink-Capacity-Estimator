...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblInputsNr.setText(QCoreApplication.translate("MainWindow", u"Configuration", None))
        self.lblNumerology.setText(QCoreApplication.translate("MainWindow", u"Numerology", None))
#if QT_CONFIG(tooltip)
        self.lblResourceBlocks.setToolTip(QCoreApplication.translate("MainWindow", u"Physical Resource Blocks", None))
#endif // QT_CONFIG(tooltip)
        self.lblResourceBlocks.setText(QCoreApplication.translate("MainWindow", u"Number of PRBs", None))
        self.spinResourceBlocksNr.setSuffix("")
        self.lblLayers.setText(QCoreApplication.translate("MainWindow", u"Number of Layers", None))
#if QT_CONFIG(tooltip)
        ...
        self.lblBlindTransmissions.setText(QCoreApplication.translate("MainWindow", u"Number of Blind Transmissions", None))
        ...
        self.lblInputsLte.setText(QCoreApplication.translate("MainWindow", u"Configuration", None))
#if QT_CONFIG(tooltip)
        self.lblMcs.setToolTip(QCoreApplication.translate("MainWindow", u"Modulation and Coding Scheme", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.label_2.setToolTip(QCoreApplication.translate("MainWindow", u"Physical Sidelink Control Channel Length", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.btnClearLte.setText(QCoreApplication.translate("MainWindow", u"Reset", None))
